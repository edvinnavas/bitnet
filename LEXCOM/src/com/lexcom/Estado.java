...
public class Estado extends javax.swing.JDialog {
    ...
    public Estado(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Estado drive = new com.lexcom.driver.Estado(this.conn, this.usuario);
        com.lexcom.driver.Estado resultado = drive.obtener(seleccion);
