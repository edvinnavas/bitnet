...
public class Presentar_Demanda extends javax.swing.JInternalFrame {

    Connection conn;
    Integer usuario;
    
    public Presentar_Demanda(Connection conn, Integer usuario) {
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        tblListaDeudores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DEUDOR", "CASO", "GARANTÍA", "NOMBRE DEUDOR", "STATUS", "SITUACION CASO", "PROCURACIÓN"
            }
        ) {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (status == JFileChooser.APPROVE_OPTION) {
            ...
            com.lexcom.driver.Presentar_Demanda DM = new com.lexcom.driver.Presentar_Demanda(this.conn,this.usuario);
