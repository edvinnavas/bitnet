...
public class Tipo_Descuento extends javax.swing.JDialog {
    ...
    public Tipo_Descuento(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Tipo_Descuento drive = new com.lexcom.driver.Tipo_Descuento(this.conn, this.usuario);
        com.lexcom.driver.Tipo_Descuento resultado = drive.obtener(seleccion);
