...
public class Rotacion_Cartera extends javax.swing.JInternalFrame {

    Connection conn;
    Integer usuario;
    
    public Rotacion_Cartera(Connection conn, Integer usuario) {
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        tblListaDeudores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Deudor", "Caso", "Antiguedad", "Fecha Recepción", "No. Cuenta", "Nombre Deudor", "Monto Inicial", "Garantía", "Estado", "Fecha Próximo Pago", "Cuota", "Gestor", "Codigo Contactabilidad"
            }
        ) {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (status == JFileChooser.APPROVE_OPTION) {
            ...
            com.lexcom.driver.Rotacion_Cartera DM = new com.lexcom.driver.Rotacion_Cartera(this.conn,this.usuario);
