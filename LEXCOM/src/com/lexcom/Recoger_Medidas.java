...
public class Recoger_Medidas extends javax.swing.JInternalFrame {

    Connection conn;
    Integer usuario;
    
    public Recoger_Medidas(Connection conn, Integer usuario) {
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        tblListaDeudores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DEUDOR", "CASO", "NOMBRE DEUDOR", "PROCURADOR", "JUZGADO", "NO JUICIO", "NOTIFICADOR", "ESTADO", "STATUS", "PROCURACION", "SITUACION CASO", "RAZON NOTIFICACION", "PAGOS", "ARRAIGO", "ARRAIGO_FECHA", "BANCOS", "BANCOS_FECHA", "FINCA", "FINCA_LETRA", "FINCA_FECHA", "FINCA_TRAMITE", "SALARIO", "SALARIO_EMPRESA", "SALARIO_FECHA", "VEHICULO", "VEHICULO_MEDIDA", "VEHICULO_FECHA", "OTROS", "OTROS_MEDIDA", "OTROS_FECHA"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                true, false, false, true, true, true, true, true, true, true, true, true, false, true, false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true
            };
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (status == JFileChooser.APPROVE_OPTION) {
            ...
            com.lexcom.driver.Recoger_Medidas DM = new com.lexcom.driver.Recoger_Medidas(this.conn,this.usuario);
