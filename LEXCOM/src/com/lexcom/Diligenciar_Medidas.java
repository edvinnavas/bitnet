...
public class Diligenciar_Medidas extends javax.swing.JInternalFrame {

    Connection conn;
    Integer usuario;
    
    public Diligenciar_Medidas(Connection conn, Integer usuario) {
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        tblListaDeudores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DEUDOR", "CASO", "GARANTÍA", "NOMBRE DEUDOR", "STATUS", "SITUACION CASO", "PROCURACIÓN", "JUZGADO", "NO_JUICIO", "NOTIFICADOR", "PROCURADOR", "ARRAIGO", "FECHA", "BANCOS", "FECHA"
            }
        ) {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (status == JFileChooser.APPROVE_OPTION) {
            ...
            com.lexcom.driver.Diligenciar_Medidas DM = new com.lexcom.driver.Diligenciar_Medidas(this.conn,this.usuario);
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        com.lexcom.driver.Diligenciar_Medidas DM = new com.lexcom.driver.Diligenciar_Medidas(this.conn, this.usuario);
        String mensaje = DM.cargar_juicios((DefaultTableModel) this.tblListaDeudores.getModel());
