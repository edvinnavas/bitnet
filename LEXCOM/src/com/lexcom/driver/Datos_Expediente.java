    ...
    public DefaultTableModel obtener_tabla(String patron, Boolean solo_cargados) {
        ...
        try {
            ...
            String cadenasql = "SELECT "
                    + "d.deudor AS 'ID DEUDOR', "
                    + "a.nombre AS 'ACTOR', "
                    + "d.caso AS 'CASO', "
                    + "d.nombre AS 'NOMBRE', "
                    + "d.fecha_ingreso AS 'FECHA INGRESO', "
                    + "u.nombre AS 'GESTOR', "
                    + "s.nombre AS 'ESTADO JUDICIAL', "
                    + "e.nombre AS 'ESTATUS JUDICIAL', "
                    + "ga.nombre AS 'GARANTIA', "
                    + "d.no_cuenta AS 'NO CUENTA', "
                    + "d.no_cuenta_otro AS 'OTRO NO CUENTA', "
                    + "j.no_juicio AS 'NO JUICIO', "
                    + "d.cargado AS 'CARGADO', "
                    + "if(d.cuenta_principal_relacion=0,'NO','SI') 'CUENTA PRINCIPAL REL', "
                    + "d.deudor_cuenta_relacionada 'CUENTA RELACIONADA' "
                    + "FROM "
                    + "deudor d "
                    ...
                    + "d.deudor like '%" + patron + "%' or "
                    + "d.deudor_cuenta_relacionada like '%" + patron + "%' or "
