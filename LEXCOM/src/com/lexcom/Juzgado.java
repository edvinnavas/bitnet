...
public class Juzgado extends javax.swing.JDialog {
    ...
    public Juzgado(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Juzgado drive = new com.lexcom.driver.Juzgado(this.conn, this.usuario);
        com.lexcom.driver.Juzgado resultado = drive.obtener(seleccion);
