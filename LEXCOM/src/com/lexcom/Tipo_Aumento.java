...
public class Tipo_Aumento extends javax.swing.JDialog {
    ...
    public Tipo_Aumento(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Tipo_Aumento drive = new com.lexcom.driver.Tipo_Aumento(this.conn, this.usuario);
        com.lexcom.driver.Tipo_Aumento resultado = drive.obtener(seleccion);
