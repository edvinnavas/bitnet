...
public class Codigo_Contactabilidad extends javax.swing.JDialog {
    ...
    public Codigo_Contactabilidad(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        setTitle("CODIGO CONTACTABILIDAD");
        setResizable(false);
    ...
    private void insertar() {
        ...
        String resultado = drive.insertar(this.txtCodigo.getText(), this.txtNombre.getText(), "VIGENTE", this.areDescripcion.getText());
    ...
    private void modificar() {
        com.lexcom.driver.Codigo_Contactabilidad drive = new com.lexcom.driver.Codigo_Contactabilidad(this.conn, this.usuario);
        String resultado = drive.modificar(this.txtCodigo.getText(), this.txtNombre.getText(), this.seleccion, this.areDescripcion.getText());
        String[] mensaje = resultado.split(",");
        JOptionPane.showMessageDialog(null, mensaje[1]);
        if(mensaje[0].equals("1")) {
            this.dispose();
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Codigo_Contactabilidad drive = new com.lexcom.driver.Codigo_Contactabilidad(this.conn, this.usuario);
        com.lexcom.driver.Codigo_Contactabilidad resultado = drive.obtener(seleccion);
        
        this.txtCodigo.setText(resultado.codigo);
