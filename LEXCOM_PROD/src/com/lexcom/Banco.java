...
public class Banco extends javax.swing.JDialog {
    ...
    public Banco(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Banco drive = new com.lexcom.driver.Banco(this.conn, this.usuario);
        com.lexcom.driver.Banco resultado = drive.obtener(seleccion);
