...
public class Cooperacion extends javax.swing.JDialog {
    ...
    public Cooperacion(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Cooperacion drive = new com.lexcom.driver.Cooperacion(this.conn, this.usuario);
        com.lexcom.driver.Cooperacion resultado = drive.obtener(seleccion);
