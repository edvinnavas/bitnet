...
public class Garantia extends javax.swing.JDialog {
    ...
    public Garantia(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario, Integer accion) {
        super(parent, modal);
        this.conn = conn;
    ...
    public void cargar(Integer seleccion) {
        ...
        com.lexcom.driver.Garantia drive = new com.lexcom.driver.Garantia(this.conn, this.usuario);
        com.lexcom.driver.Garantia resultado = drive.obtener(seleccion);
