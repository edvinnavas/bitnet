...
@ManagedBean(name = "SestadoExtra")
@ViewScoped
public class SestadoExtra implements Serializable {
    ...
    private SestadoExtra_List selectedSestado;
    private List<SestadoExtra_List> lst_sestado;
    ...
    public void init() {
        try {
            ...
            for(Integer i = 1; i < filas; i++) {
                SestadoExtra_List ses = new SestadoExtra_List(
    ...
    public void carga_info_modificar() {
        if(this.selectedSestado != null) {
            String cadenasql = "select "
                    ...
                    + "sestado_extra s "
                    + "where "
                    + "s.sestado_extra = " + this.selectedSestado.getSestado();
            Servicio servicio = new Servicio();
            java.util.List<lexcom.ws.StringArray> resultado = servicio.reporte(cadenasql, this.ambiente);
            Integer filas = resultado.size();
            Integer columnas = resultado.get(0).getItem().size();
    ...
    private void insertar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                resultado = servicio.estadoExtraInsertar(
                        id_usuario,
                        this.nombre_d,
                        this.descripcion_d, 
                        this.ambiente);
    ...
    private void modificar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                Servicio servicio = new Servicio();
                Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
                resultado = servicio.estadoExtraModificar(
                        id_usuario,
    ...
    private void eliminar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.estadoExtraEliminar(
                    id_usuario,
                    this.selectedSestado.getSestado(), 
                    this.ambiente);
            this.constructor();
    ...
    private void activar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.estadoExtraActivar(
                    id_usuario,
                    this.selectedSestado.getSestado(), 
                    this.ambiente);
            this.constructor();
    ...
    public SestadoExtra_List getSelectedSestado() {
        return selectedSestado;
    }

    public void setSelectedSestado(SestadoExtra_List selectedSestado) {
        this.selectedSestado = selectedSestado;
    }

    public List<SestadoExtra_List> getLst_sestado() {
        return lst_sestado;
    }

    public void setLst_sestado(List<SestadoExtra_List> lst_sestado) {
