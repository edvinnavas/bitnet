...
public class Permisos_Menu implements Serializable {
    ...
    public void guardar() {
        ...
        try {
            ...
            // resultado = servicio.permisosUsuarioUnoModificar(id_usuario, this.user, this.lst_usuario_permisos.getSource(), this.lst_usuario_permisos.getTarget(), this.ambiente);
            this.constructor();
    ...
    public String getPermisos_Usuarios() {
        return Permisos_Usuarios;
    }

    public void setPermisos_Usuarios(String Permisos_Usuarios) {
    ...
    public ArrayList<Object> getLst_menu_asignados() {
        return lst_menu_asignados;
    }

    public void setLst_menu_asignados(ArrayList<Object> lst_menu_asignados) {
        this.lst_menu_asignados = lst_menu_asignados;
    }

    public DualListModel<Object> getLst_usuario_permisos() {
        return lst_usuario_permisos;
    }

    public void setLst_usuario_permisos(DualListModel<Object> lst_usuario_permisos) {
