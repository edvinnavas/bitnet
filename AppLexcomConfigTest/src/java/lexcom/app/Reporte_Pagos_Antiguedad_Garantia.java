...
@ManagedBean(name = "Reporte_Pagos_Antiguedad_Garantia")
@ViewScoped
public class Reporte_Pagos_Antiguedad_Garantia implements Serializable {
    ...
    public void init() {
        ...
        this.archivo = drive.getPath() + this.usuario + "_reporte_pagos_antiguedad_garantia.xls";
        ...
        try {
            ...
            if (!t_fecha1.equals("") && !t_fecha2.equals("") && corporacion != null) {
                ...
                String cadenasql = "select "
                        ...
                        + "where "
                        + "(d.cargado='CARGADO') "
                        + "and (p.fecha_registro between '" + t_fecha1 + "' and '" + t_fecha2 + "') "
                        + "and (p.monto > 0.00) "
                ...
                file = new DefaultStreamedContent(stream, "resources/img/Encabezado.png", "ReportePagosAntiguedadGarantia_" + sdf.format(cal.getTime()) + ".xls");
            } else {
