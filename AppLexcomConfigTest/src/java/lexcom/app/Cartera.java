...
public class Cartera implements Serializable {
    ...
    private Cartera_List selectedCartera;
    private List<Cartera_List> lst_cartera;
    ...
    public void init() {
        try {
            ...
            lst_cartera = new ArrayList<>();
            for(Integer i = 1; i < filas; i++) {
                Cartera_List car = new Cartera_List(
    ...
    public void carga_info_modificar() {
        if(this.selectedCartera != null) {
            String cadenasql = "select "
                    ...
                    + "cartera c "
                    + "where "
                    + "c.cartera = " + this.selectedCartera.getCartera();
            Servicio servicio = new Servicio();
            java.util.List<lexcom.ws.StringArray> resultado = servicio.reporte(cadenasql, this.ambiente);
            Integer filas = resultado.size();
            Integer columnas = resultado.get(0).getItem().size();
    ...
    private void insertar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                resultado = servicio.carteraInsertar(
                        id_usuario,
                        this.nombre_d,
                        this.descripcion_d, 
                        this.ambiente);
    ...
    private void modificar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                Servicio servicio = new Servicio();
                Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
                resultado = servicio.carteraModificar(
                        id_usuario,
                        this.selectedCartera.getCartera(),
                        this.nombre_d,
                        this.descripcion_d, 
                        this.ambiente);
                this.constructor();
    ...
    private void eliminar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.carteraEliminar(
                    id_usuario,
                    this.selectedCartera.getCartera(), 
                    this.ambiente);
            this.constructor();
    ...
    private void activar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.carteraActivar(
                    id_usuario,
                    this.selectedCartera.getCartera(), 
                    this.ambiente);
            this.constructor();
    ...
    public Cartera_List getSelectedCartera() {
        return selectedCartera;
    }

    public void setSelectedCartera(Cartera_List selectedCartera) {
        this.selectedCartera = selectedCartera;
    }

    public List<Cartera_List> getLst_cartera() {
        return lst_cartera;
    }

    public void setLst_cartera(List<Cartera_List> lst_cartera) {
