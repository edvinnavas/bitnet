...
@ManagedBean(name = "Archivo_Caratula")
@ViewScoped
public class Archivo_Caratula implements Serializable {
    ...
    public void init() {
        ...
        this.archivo = drive.getPath() + this.usuario + "_archivo_caratula.xls";
    ...
    public void generar_reporte() {
        try {
            ...
            file = new DefaultStreamedContent(stream, "resources/img/Encabezado.png", "ArchivoCaratula_" + sdf.format(cal.getTime()) + ".xls");
        } catch (Exception ex) {
