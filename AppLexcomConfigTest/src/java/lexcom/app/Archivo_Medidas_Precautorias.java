...
@ManagedBean(name = "Archivo_Medidas_Precautorias")
@ViewScoped
public class Archivo_Medidas_Precautorias implements Serializable {
    ...
    public void init() {
        ...
        this.archivo = drive.getPath() + this.usuario + "_archivo_medidas_precautorias.xls";
    ...
    public void generar_reporte() {
        try {
            ...
            file = new DefaultStreamedContent(stream, "resources/img/Encabezado.png", "ArchivoMedidasPrecautorias_" + sdf.format(cal.getTime()) + ".xls");
        } catch (Exception ex) {
