    ...
    public String modificar_juicio(
        ...
        try {
            ...
            String cadenasql = "update juicio set "
                    ...
                    + "fecha_admision_demanda='" + quitar_simbolos(fecha_admision) + "', "
            ...
            com.lexcom.driver.Evento drive = new com.lexcom.driver.Evento(conn);
            drive.insertar(this.usuario_sys, "Juicio modificado=>  Deudor: " + deudor + " juzgado: " + juzgado.toString() + " fecha " + fecha_juicio + " no_juicio: " + no_juicio + " notificador: " + notificador + " abogado_deudor: " + abogado_deudor + " tipo_juicio: " + tipo_juicio + " memorial: " + fecha_memorial + " Procuración: " + procuracion + " titulo_ejecutivo: " + titulo_ejecutivo, 1);
        } catch (SQLException ex) {
            try {
                conn.rollback();
                resultado = "2," + ex.toString();
