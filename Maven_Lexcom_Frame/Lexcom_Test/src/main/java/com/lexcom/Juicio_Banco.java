...
public class Juicio_Banco extends javax.swing.JDialog {
    ...
    public Juicio_Banco(java.awt.Frame parent, boolean modal, Connection conn, Integer usuario) {
        super(parent, modal);
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        cbxBancos.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "PEDIDO", "NO PEDIDO", "DECRETADO", "NO DECRETADO", "DILIGENCIADO" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbxBancos, 0, 303, Short.MAX_VALUE)
                    .addComponent(dccDeligenciado, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        this.bancos = this.cbxBancos.getSelectedItem().toString();
        this.deligenciado = this.dccDeligenciado.getSelectedDate();
        this.dispose();
    }//GEN-LAST:event_btnAceptarActionPerformed

    public void cargar_datos(String banco, Calendar deligencia) {
        this.cbxBancos.setSelectedItem(banco);
