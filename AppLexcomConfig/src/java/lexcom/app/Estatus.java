...
public class Estatus implements Serializable {
    ...
    private Estatus_List selectedEstatus;
    private List<Estatus_List> lst_estatus;
    ...
    public void init() {
        try {
            ...
            for(Integer i = 1; i < filas; i++) {
                Estatus_List cor = new Estatus_List(
    ...
    public void carga_info_modificar() {
        if(this.selectedEstatus != null) {
            String cadenasql = "select "
                    ...
                    + "estatus e "
                    + "where "
                    + "e.estatus = " + this.selectedEstatus.getEstatus();
            Servicio servicio = new Servicio();
            java.util.List<lexcom.ws.StringArray> resultado = servicio.reporte(cadenasql, this.ambiente);
            Integer filas = resultado.size();
            Integer columnas = resultado.get(0).getItem().size();
    ...
    private void insertar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                resultado = servicio.statusInsertar(
                        id_usuario,
                        this.nombre_d,
                        this.descripcion_d, 
                        this.ambiente);
    ...
    private void modificar() {
        ...
        try {
            if (!this.nombre_d.equals("")) {
                ...
                Servicio servicio = new Servicio();
                Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
                resultado = servicio.statusModificar(
                        id_usuario,
    ...
    private void eliminar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.statusEliminar(
                    id_usuario,
                    this.selectedEstatus.getEstatus(), 
                    this.ambiente);
            this.constructor();
    ...
    private void activar() {
        ...
        try {
            ...
            Servicio servicio = new Servicio();
            Integer id_usuario = driver.getInt("select u.usuario from usuario u where u.nombre = '" + this.usuario + "'", this.ambiente);
            resultado = servicio.statusActivar(
                    id_usuario,
                    this.selectedEstatus.getEstatus(), 
                    this.ambiente);
            this.constructor();
    ...
    public Estatus_List getSelectedEstatus() {
        return selectedEstatus;
    }

    public void setSelectedEstatus(Estatus_List selectedEstatus) {
        this.selectedEstatus = selectedEstatus;
    }

    public List<Estatus_List> getLst_estatus() {
        return lst_estatus;
    }

    public void setLst_estatus(List<Estatus_List> lst_estatus) {
