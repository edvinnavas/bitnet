...
@ManagedBean(name = "Archivo_Deudores_Carga")
@ViewScoped
public class Archivo_Deudores_Carga implements Serializable {
    ...
    public void init() {
        ...
        this.archivo = drive.getPath() + this.usuario + "_archivo_deudor_carga.xls";
    ...
    public void generar_reporte() {
        try {
            ...
            file = new DefaultStreamedContent(stream, "resources/img/Encabezado.png", "ArchivoCargaDeudores_" + sdf.format(cal.getTime()) + ".xls");
        } catch (Exception ex) {
