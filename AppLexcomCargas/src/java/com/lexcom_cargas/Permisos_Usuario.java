...
public class Permisos_Usuario implements Serializable {
    ...
    public void guardar() {
        ...
        try {
            ...
            resultado = servicio.permisosUsuarioUnoModificar(id_usuario, this.user,this.lst_usuario_permisos.getSource() ,this.lst_usuario_permisos.getTarget(), "LEXCOMJNDI");
            this.constructor();
