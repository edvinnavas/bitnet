...
public class Permisos_Rol implements Serializable {
    ...
    public void init() {
        try {
            ...
            this.lst_Rol = drive.lista_SelectItem_simple(lista_sql);
    ...
    public void constructor() {
        try {
            ...
            this.lst_Rol = drive.lista_SelectItem_simple(lista_user_sql);
            if(this.lst_Rol.size() > 0) {
                this.rol = Integer.parseInt(this.lst_Rol.get(0).getValue().toString());
            } else {
                this.rol = 0;
    ...
    public void guardar() {
        ...
        try {
            ...
            resultado = servicio.permisosRolModificar(id_usuario, this.rol,this.lst_Rol_permisos.getSource() ,this.lst_Rol_permisos.getTarget(), "LEXCOMJNDI");
            this.constructor();
